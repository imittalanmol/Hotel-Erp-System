 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">A landmark in itself, Sun Rise has been acknowledged as the preferred residence of visiting heads of state and global icons for over 40 years and epitomizes the luxury hotel experience in New Delhi. This luxury hotel welcomes guests to 412 rooms & 25 suites each of which is a triumph of stunning aesthetics. With the iconic Bukhara & celebrated Dum Pukht, the hotel has an enviable collection of culinary destinations, alongside magnificent conference and banquet venues & unmatched wellness facilities. Sun-Rise is one of the most coveted address in the country.</p>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Lucas Jimenez</h4>
							<span>Manager</span>
							<p>We believe that our success should benefit the community and that our
prosperity should buoy the local economy. We will contribute to the development
of our location and support its trade, integrate our business with its industries,
and support its initiatives. </p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>The room was clean. The surroundings and the hygiene was also good at the hotel. Staff was courteous and was quick to resolve any query.Overall it was good experience.  </p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Food was excellent and their managers in restaurant were very helpful. Due to fast, my wife wanted some different fruits , which were not on table. Same was provided promptly without Any extra charge. </p>
								<h5>Jainath Shree</h5>
								<p>Indian</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Almost everything .. service .. food ... Ambience all were above expectation ... Even the staff were bery supportive and fulfilled even our small requirements ... That was really not expected... Would suggest everyone if you want to stay peacefully  </p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Address :</strong> Sardar Patel Marg, Akhaura Block, Diplomatic Enclave, Chanakyapuri, New Delhi, Delhi 110021 </p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 SUNRISE . All Rights Reserved | Design by Anmol Mittal <a href="index.php">SUNRISE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
